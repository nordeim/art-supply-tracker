...
- **The app authors ZERO forced-colors rules (r20)** — the live's CSSOM
  carries none, and TW4's transparent-outline utility (the forced-colors-
  aware `outline-hidden`) is the only emitter of `@media
