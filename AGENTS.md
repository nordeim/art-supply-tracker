...
- `docs/artsupplytracker-dashboard.png` — the reference screenshot the UI was
  cloned from.
- `docs/session_47.md` — the r27 round record (the login input chrome,
  the eye's a11y contract, the reset views, the 357px card cap, and the
  paired-capture state-verification rule).
